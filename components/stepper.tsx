...
export function Stepper({
  ...
  return (
    <div className="relative flex w-full items-start justify-between">
      ...
      />
      <motion.div
        className="absolute top-4 h-0.5 origin-left bg-primary"
        style={{ left: inset, right: inset }}
        initial={{ scaleX: 0 }}
      ...
      {steps.map((step, idx) => {
        ...
        return (
          ...
          >
            <motion.span
              className={cn(
                ...
                isCompleted || isActive
                  ...
                  : "border bg-background text-muted-foreground group-hover:text-foreground"
              )}
            ...
            <span
              className={cn(
                "mt-2 hidden select-none text-xs tracking-wide transition-colors duration-300 sm:block",
                isActive
